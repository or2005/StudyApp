...
def compute_level(
    ...
    recs = {
        "beginner": [
            rtl("התחילו משיעורים בסיסיים בכל מקצוע"),
            rtl("תרגלו בערך 10 שאלות ביום עם הסבר אחרי כל תשובה"),
            rtl("קראו את ההסבר אחרי טעות, לפני שעוברים הלאה"),
        ],
        "intermediate": [
            rtl("שלבו שיעור קצר עם תרגול יומי בנושאים שטעיתם בהם"),
            rtl("עשו מבחן דמה פעם בשבוע כדי לראות אם זה מחזיק"),
            rtl("חזרו לנושאים החלשים מהאבחון"),
        ],
        "advanced": [
            rtl("עברו למבחנים מלאים כדי להתאמן על מצב בגרות"),
            rtl("תרגלו שאלות קשות ושמרו על קצב קריאה רגוע"),
            rtl("חזרו על נושאים עם פחות מ־80% הצלחה"),
        ],
    }[level]
