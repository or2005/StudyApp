...
def _heb_spelling() -> list:
    ...
    items = [
        ...
        ("מה צורת הרבים של «ספר»?", "ספרים", ["ספרות תמיד כאן", "ספרי", "ספררים"], "ספר → ספרים."),
        ("מה צורת הרבים של «מילה»?", "מילים", ["מילות חובה תמיד", "מילהים", "מלין"], "מילה → מילים."),
...
def _heb_syntax() -> list:
    return [
        ...
        _q("את מה מתאר הלוואי במשפט?", "שם עצם", ["רק פועל", "רק מילת יחס", "רק מספר"], _why("הבית הגדול, גדול לוואי של בית.", "צמוד לשם."), "Medium"),
