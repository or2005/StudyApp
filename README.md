...
**גרסה 4.6.0** · אור דדשב · dadshaev@gmail.com

## הורדה

| מערכת | קובץ |
|---|---|
| Windows 10 / 11 | `StudyApp-4.6.0-setup.exe` (קובץ התקנה) |
| כל לינוקס | `StudyApp-4.6.0-linux-portable.tar.gz` |

### Windows

לחצו פעמיים על `StudyApp-4.6.0-setup.exe` ועקבו אחרי האשף. אפשר גם לחלץ את ה-ZIP ולהפעיל `StudyApp.exe`.

### לינוקס

```
tar -xzf StudyApp-4.6.0-linux-portable.tar.gz
cd StudyApp
chmod +x StudyApp.sh
./StudyApp.sh
```
