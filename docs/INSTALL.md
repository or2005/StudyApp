...
1. הורידו `StudyApp-4.5.1-setup.exe`.
...
1. הורידו `StudyApp-4.5.1-windows.zip`.
...
הפלט: `dist\StudyApp-4.5.1-setup.exe` וגם עותק על שולחן העבודה.
