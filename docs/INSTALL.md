...
1. הורידו `StudyApp-4.5.0-setup.exe`.
...
1. הורידו `StudyApp-4.5.0-windows.zip`.
...
הפלט: `dist\StudyApp-4.5.0-setup.exe` וגם עותק על שולחן העבודה.
