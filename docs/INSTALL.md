...
1. הורידו `StudyApp-4.5.2-setup.exe`.
...
1. הורידו `StudyApp-4.5.2-windows.zip`.
...
הפלט: `dist\StudyApp-4.5.2-setup.exe` וגם עותק על שולחן העבודה.
