...
1. הורידו `StudyApp-4.5.3-setup.exe`.
...
1. הורידו `StudyApp-4.5.3-windows.zip`.
...
הפלט: `dist\StudyApp-4.5.3-setup.exe` וגם עותק על שולחן העבודה.
